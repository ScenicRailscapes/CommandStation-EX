int cab_now=4;  // Global variable; laatste bekende loc die reed met snelheid >0
...
void halSetup() {
  ...
  //PCA9685::create(500, 16, 0x40);
  //PCA9685::create(520, 16, 0x41);
...
// #1n vPin 300-307
  //PCF8574::create(300, 8, 0x22);
//#2 vPin 308-315
  //PCF8574::create(308, 8, 0x23);

  // Alternative form using INT pin (see above)

  //PCF8574::create(200, 8, 0x22, 40);
 ...
 //=======================================================================
  ...
  //I2CDFPlayer::create(10001, 1, 0x4C, 1);
  //I2CDFPlayer::create(10002, 1, 0x49, 1);
  //
