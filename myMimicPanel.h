...
BIND_TURNOUT_MIMIC(1012, 11030, 4)
BIND_TURNOUT_MIMIC_REVERSE(1013, 11124, 4)
BIND_TURNOUT_MIMIC_REVERSE(1018, 11081, 3)
BIND_TURNOUT_MIMIC(1019, 11079, 2)
BIND_TURNOUT_MIMIC(1020, 11066, 4)
BIND_TURNOUT_MIMIC_REVERSE(1021, 11074, 2)
BIND_TURNOUT_MIMIC_REVERSE(1022, 11092, 4)
BIND_TURNOUT_MIMIC(1023, 11072, 2)
BIND_TURNOUT_MIMIC_REVERSE(1024, 11076, 3)

// Schaduwstation
BIND_TURNOUT_MIMIC(1011, 11150, 2)
BIND_TURNOUT_MIMIC(1010, 11152, 2)
BIND_TURNOUT_MIMIC(1009, 11154, 2)
BIND_TURNOUT_MIMIC(1015, 11160, 1)
BIND_TURNOUT_MIMIC(1016, 11161, 2)
BIND_TURNOUT_MIMIC(1017, 11163, 2)

// Speciale wissel 1025 (S25)
ONCLOSE(1025)
...
// schaduwstation
BIND_SENSOR_MIMIC(BD_S_1_BEZET,   11156, 2)
BIND_SENSOR_MIMIC(BD_S_2_BEZET,   11158, 2)
BIND_SENSOR_MIMIC(BD_S_3_BEZET,   11184, 2)
BIND_SENSOR_MIMIC(BD_S_4_BEZET,   11182, 2)
BIND_SENSOR_MIMIC(BD_S_5_BEZET,   11176, 6)
BIND_SENSOR_MIMIC(BD_S_RIJ_BEZET, 11168, 8)

// BD_HBU_1 stuurt 3 losse segmenten aan en heeft meerdere seinen, hier een blocksein
ONBITMAP(BD_HBU_1_BEZET)
  IF(BD_HBU_1_BEZET)
