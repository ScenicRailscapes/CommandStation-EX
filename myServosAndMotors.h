...
SERVO_TURNOUT(1002, 402, 260, 170, Fast, "Yard dal - Helix buitenring")             // S02
SERVO_TURNOUT(1003, 403, 255, 180, Fast, "Yard dal") // yard dal - terug naar vissersdorp   // S03
SERVO_TURNOUT(1004, 404, 250, 160, Fast, "Yard oost")
SERVO_TURNOUT(1005, 405, 270, 200, Fast, "Yard west")
SERVO_TURNOUT(1006, 406, 410, 310, Fast, "Helix buitenring / dorp")
SERVO_TURNOUT(1007, 407, 410, 310, Fast, "Branchlijn hoofdstation / Haven-dorp")    // S08
...
SERVO_TURNOUT(1020, 420, 260, 170, Fast, "SchaduwStat 1 en 2 links")
SERVO_TURNOUT(1021, 421, 270, 200, Fast, "SchaduwStat 3 en 4 links")
SERVO_TURNOUT(1022, 422, 260, 190, Fast, "SchaduwStat 5 en 6 links")
SERVO_TURNOUT(1023, 423, 250, 160, Fast, "Helix binnenring / bergdorp station") // S12
SERVO_TURNOUT(1024, 424, 270, 170, Fast, "Dorp branchlijn / brouwerij")         // S13
...
SERVO_TURNOUT(1030, 440, 320, 210, Fast, "SchaduwStat 1 en 2 rechts")   // S15
SERVO_TURNOUT(1031, 441, 290, 210, Fast, "SchaduwStat 3 en 4 rechts")   // S16
SERVO_TURNOUT(1032, 442, 270, 190, Fast, "SchaduwStat 5 en 6 rechts")   // S17
SERVO_TURNOUT(1033, 443, 250, 160, Fast, "Locoshed / haven")            // S18
SERVO_TURNOUT(1034, 444, 350, 280, Fast, "Haven - dorp branchlijn")     // S19 (defect??)
SERVO_TURNOUT(1035, 445, 350, 250, Fast, "Main #1 / schaduwstation")    // S20 hoofdspoor 1 / schaduwstation
SERVO_TURNOUT(1036, 446, 280, 130, Fast, "Dorp / dal")                  // S21
SERVO_TURNOUT(1037, 447, 250, 160, Fast, "Dorp / Vissersdorp station")  // S22
SERVO_TURNOUT(1038, 448, 290, 220, Fast, "Haven / main #1")             // S23
SERVO_TURNOUT(1039, 449, 335, 235, Fast, "Haven - dorp / main #2")      // S24
SERVO_TURNOUT(1040, 450, 250, 150, Fast, "main #1 / main #2")           // S25
